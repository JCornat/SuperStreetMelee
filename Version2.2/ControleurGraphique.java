	...
	class ClavierListener implements KeyListener {
		...
		////////////////// PLAYER 2 ///////////////////////
			...
			case KeyEvent.VK_RIGHT:
				...
				break;
			case KeyEvent.VK_1:
				tabJoueurs.get(0).receiveHit(5);
				break;
			case KeyEvent.VK_2:
				tabJoueurs.get(1).receiveHit(5);
				break;
			case KeyEvent.VK_3:
				tabJoueurs.get(0).receiveHeal(10);
				break;
			case KeyEvent.VK_4:
				tabJoueurs.get(1).receiveHeal(10);
				break;
			case KeyEvent.VK_5:
				tabJoueurs.get(0).getResurected(30);
				break;
			case KeyEvent.VK_6:
				tabJoueurs.get(1).getResurected(30);
				break;
